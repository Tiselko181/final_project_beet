        ...
        <>
            <div className={`playBtn ${game.active ? 'playBtn-active' : undefined}`}>
                <a href="#"
                    ...
                    className='group relative inline-flex items-center gap-2.5 mr-[15px] py-[5px] px-4 no-underline text-lg font-normal tracking-[1px] uppercase duration-300 text-[#ff3700] bg-white !cursor-pointer border-0 hover:!text-white hover:!bg-[#ff3700]'>
