...
function Game() {
    ...
    return (
        <main>
            <section className="relative w-full min-h-screen lg:px-[100px] py-0 overflow-hidden after:absolute after:content-[''] after:w-full after:h-full after:bg-[#121212cd] after:inset-x-0 after:inset-y-0" >
                <GoBackDtn />
