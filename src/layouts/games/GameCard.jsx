...
function GameCard({ game }) {
    return (
        <Link to={`/games/${game.slug}`} className="lg:basis-1/6">
            <div className="group border-none relative rounded-none bg-black shadow-[0_0_16px] shadow-[#ffffff7f] before:absolute before:content-[''] before:inset-x-0 before:inset-y-0 before:bg-[rgba(0,0,0,0.29)]">
                <div className="absolute top-0 w-full h-[15%] flex justify-between items-center text-white bg-[rgba(0,0,0,0.29)] cursor-auto">
